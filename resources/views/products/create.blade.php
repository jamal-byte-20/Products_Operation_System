...
@section('title', 'Add Product | StockOps')
...
<div class="mx-auto max-w-2xl">
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Add Product</h1>
        <p class="mt-1 text-sm text-slate-500 font-medium">Create a new product listing in your inventory.</p>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-8">
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <!-- Stock -->
                <div>
                    <label for="stock" class="block text-sm font-semibold text-slate-900">Initial Stock</label>
                    <div class="mt-2">
            ...
            <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
                <a href="{{ route('products.index') }}" class="rounded-xl border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-650 hover:bg-slate-50 transition">
                    Cancel
                </a>
